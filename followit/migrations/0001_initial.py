...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FollowRecord'
        db.create_table(u'followit_followrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followed_record_contenttype', to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'followit', ['FollowRecord'])


    def backwards(self, orm):
        # Deleting model 'FollowRecord'
        db.delete_table(u'followit_followrecord')
